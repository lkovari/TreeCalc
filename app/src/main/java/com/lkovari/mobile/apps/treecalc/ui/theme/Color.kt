...
val LightPalette = TreeCalcPalette(
    ...
    splashTop = Color(0xFFE8F4FC),
    splashMid = Color(0xFFD6ECF8),
    splashBottom = Color(0xFFC5E0F4),
    splashOn = InkRose,
    splashTagline = Color(0xFF2E7FC4),
    splashBadgeFill = Color(0x66FFFFFF),
    splashStem = Color(0xFFA85A78),
...
val DarkPalette = TreeCalcPalette(
    ...
    splashTop = Color(0xFF2C3E4C),
    splashMid = Color(0xFF283848),
    splashBottom = Color(0xFF243240),
    splashOn = MoonCream,
    splashTagline = Color(0xFF8EC8F0),
    splashBadgeFill = Color(0x33FFFFFF),
    splashStem = Color(0xFFE0A0B4),
